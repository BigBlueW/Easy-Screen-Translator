"""
pyinstaller --onefile --add-data "Google_Translate_logo.ico;." --add-data "Tesseract-OCR;Tesseract-OCR" --hidden-import plyer.platforms.win.notification main.py --noconsole
"""
import pyperclip
...
def bind_hotkey():
    keyboard.add_hotkey('win+shift+l', take_screenshot)
    print("Win+Shift+L is set for screenshot.")
    keyboard.wait('esc')
